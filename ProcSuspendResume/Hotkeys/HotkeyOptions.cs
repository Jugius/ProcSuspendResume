...
{
    public class HotkeyOptions : IHotkey, IEquatable<HotkeyOptions>
    {
        public HotkeyOptions(ModifierKeys modifier, Keys key)
        {
            Modifier = modifier;
            Key = key;
        }
        ...
        public bool Equals(HotkeyOptions other)
        {
            return other != null
        ...
        public static HotkeyOptions LoadFromFile()
        {
            ...
            return new HotkeyOptions(modifier, key);
        }
    }
}
